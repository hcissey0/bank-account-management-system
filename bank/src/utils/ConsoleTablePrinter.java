...
public class ConsoleTablePrinter implements TablePrinter {
    ...
    private static final Logger logger = Logger.getLogger(ConsoleTablePrinter.class.getName());
    ...
    public void printTable(String[] headers, String[][] data) {
        ...
        if (data == null || data.length == 0) {
            ...
            printBorder(calculateColumnWidths(headers, null));
            logger.info("| No data available. ".concat(" ".repeat(Math.max(0, calculateTotalWidth(headers) - 20))) + "|");
            printBorder(calculateColumnWidths(headers, null));
            return;
        }
